...
public class WorkDone extends JFrame implements ActionListener {
	...
	private void addGuiComponents() {
		...
		// add scrolling to the text panel
		...
		addTaskButton.setFont(createFont("resource/LEMONMILK-Bold.otf", 16f));
